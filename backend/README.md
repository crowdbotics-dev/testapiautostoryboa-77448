...
## Project Structure
    ...
    ├── testapiautostoryboa_77448  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_77448`
...
2. Clone this repo and `cd testapiautostoryboa_77448`
